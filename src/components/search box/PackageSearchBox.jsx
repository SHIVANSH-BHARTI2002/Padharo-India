...
import { MagnifyingGlassIcon, ChevronDownIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
        ...
        <div className="w-full max-w-5xl mx-auto">
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center">
                    ...
                    {/* Removed Max Price and Min Rating filters */}

                    {/* Sort By */}
                    <div className="relative border-b lg:border-b-0 lg:border-r border-gray-200">
                        <Cog6ToothIcon className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                        <select name="sort" value={filters.sort || ''} onChange={handleInputChange} className="w-full pl-12 pr-8 py-6 bg-transparent text-gray-700 border-none outline-none appearance-none cursor-pointer">
